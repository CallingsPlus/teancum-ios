...
struct MemberEditView<Dependencies: MemberEditViewDependencies>: View {
    ...
    @State var member: Dependencies.SomeMembersService.SomeMember
...
extension MemberEditValidationError: CustomStringConvertible {
...
struct MemberEditView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        ...
        MemberEditView(dependencies: .Mock(), member: fullMember, state: .editing(.init(saveResult: .error(MemberEditValidationError.firstNameEmpty))))
            .previewLayout(PreviewLayout.fixed(width: 500, height: 700))
            .previewDisplayName("Missing First Name")
        MemberEditView(dependencies: .Mock(), member: fullMember, state: .editing(.init(saveResult: .error(MemberEditValidationError.lastNameEmpty))))
            .previewLayout(PreviewLayout.fixed(width: 500, height: 700))
